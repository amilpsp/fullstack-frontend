            ...
            <ul className="flex flex-row justify-center mt-8 mb-14 text-lg">
                <li className="px-3">
                    <svg
                        ...
                        /* IG-icon styling */
                        className="h-10 rounded-full cursor-pointer  hover:scale-110 hover:-translate-y-1 hover:fill-white duration-300 bg-txtdark hover:bg-gradient-to-tl from-ig1 via-ig2 to-ig3 ..."
                    >
                        <path
                ...
                <li className="px-3">
                    <svg
                        ...
                        viewBox="0 0 397.35 397.35"
                        /* YT-icon styling */
                        className="h-10 rounded-full cursor-pointer  hover:scale-110 hover:-translate-y-1 hover:fill-white duration-300 bg-txtdark hover:bg-gradient-to-tl from-yt1 to-yt2 ..."
                    >
                        <path
                ...
                <li className="px-3">
                    <svg
                        ...
                        viewBox="0 0 397.35 397.35"
                        /* X-icon styling */
                        className="h-10 rounded-full cursor-pointer  hover:scale-110 hover:-translate-y-1 hover:fill-white duration-300 bg-txtdark hover:bg-gradient-to-tl from-slate-500 to-slate-600 ..."
                    >
                        <path
                ...
                <li className="px-3">
                    <svg
                        ...
                        viewBox="0 0 397.35 397.35"
                        /* FB-icon styling */
                        className="h-10 rounded-full cursor-pointer  hover:scale-110 hover:-translate-y-1 hover:fill-white duration-300 bg-txtdark hover:bg-gradient-to-tl from-fb2 to-fb1 ..."
                    >
                        <path
