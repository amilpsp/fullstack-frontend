        ...
        <ul className="flex flex-row mr-16 text-sm w-[30vw] justify-end">
          <li className="px-4">
            {!user && (
              <button
                disabled
                className="flex items-center gap-2 text-txtdark stroke-txtdark h-12 hover:drop-shadow-test"
              >
                {createSvg}
                <h3>Create</h3>
              </button>
            ...
            {user && (
              <Link to="/newThread">
                <button className="flex items-center gap-2 hover:text-white hover:stroke-white stroke-txtbright text-txtbright h-12 hover:drop-shadow-test">
                  {createSvg}
                  <h3>Create</h3>
                </button>
              </Link>
