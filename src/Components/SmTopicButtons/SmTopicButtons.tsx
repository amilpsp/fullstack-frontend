const SmTopicButtons = () => {
  return (
    <div className="flex justify-between text-txtbright">
      <button className="flex items-center justify-center w-28 h-10 rounded-lg border-solid border-[1px] border-bordercol">
